...
const remoteOrigin = 'http://hotsheet-remote.test';

async function insecureOriginProxy(baseURL: string, terminalServer?: Awaited<ReturnType<typeof realTicketServer>>) {
