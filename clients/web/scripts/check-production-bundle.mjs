...
console.log(
  `Production bundle excludes Dev Review and html2canvas (${files.length} assets checked); entry point uses ${initialAssets.length} assets / ${initialAssets.length + 1} requests including the document.`,
);
