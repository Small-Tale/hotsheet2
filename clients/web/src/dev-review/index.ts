...
export function installDevReview(options: DevReviewOptions): { destroy(): void } {
  ...
  const openDialog = async () => {
    ...
    dialog.className = 'hs-dev-review__dialog dialog-surface';
