...
describe('web ESLint policy',()=>{
  ...
  it('limits defensive-condition exceptions to explained next-line boundaries',()=>{
    ...
    const exceptions=source.match(/eslint-disable-next-line @typescript-eslint\/no-unnecessary-condition -- Defensive runtime boundary intentionally exceeds its total static type\./g)??[];
