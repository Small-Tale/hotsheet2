...
type WaBase = KerfBaseAttrs & {
  ...
  clearable?: AttrLike<boolean>;
  open?: AttrLike<boolean>;
  distance?: AttrLike<number>;
  skidding?: AttrLike<number>;
  size?: AttrLike;
  variant?: AttrLike;
  appearance?: AttrLike;
  placement?: AttrLike;
  title?: AttrLike;
  type?: AttrLike;
  pill?: AttrLike<boolean>;
  'with-remove'?: AttrLike<boolean>;
  'with-caret'?: AttrLike<boolean>;
};
type SvgFilterPrimitive = KerfBaseAttrs & {
  in?: AttrLike;
  in2?: AttrLike;
  result?: AttrLike;
  stdDeviation?: AttrLike<number>;
  mode?: AttrLike;
  values?: AttrLike;
};
