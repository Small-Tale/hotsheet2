...
export function terminalDemoOutput(id:string):string {
  if(id==='tests')return `\u001b[2J\u001b[H\u001b[1;32m PASS \u001b[0m src/components/terminal-dashboard.test.ts\r\n\r\n ✓ renders an exact 80 × 24 terminal viewport\r\n ✓ keeps terminal chrome outside the PTY aspect ratio\r\n ✓ opens shared terminal actions from the footer\r\n\r\n Test Files  12 passed (12)\r\n      Tests  84 passed (84)\r\n   Duration  1.42s\r\n\r\nWatching for file changes…`;
  return `\u001b[2J\u001b[H${bar('  GNU nano 8.4                       src/main.tsx')}\u001b[2;1H${bar('File: src/main.tsx')}\u001b[4;5Himport { mount } from 'kerfjs';\u001b[6;5Hconst app = mount(root, App);\u001b[12;23H80 columns × 24 rows\u001b[23;1H${bar('^G Help  ^O Write Out  ^W Where Is  ^K Cut  ^T Execute')}\u001b[24;1H${bar('^X Exit  ^R Read File  ^\\ Replace  ^U Paste  ^J Justify')}`;
}
