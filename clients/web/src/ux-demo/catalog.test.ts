...
describe('UX demo catalog', () => {
  ...
  it('accounts for every production component in the catalog or a documented exemption', () => {
    ...
    const EXEMPT: Record<string, string> = {
      ...
      // Standalone native <dialog> needing showModal wiring per demo-select — deferred, tracked in HS2-Z0CTHN.
      'command-run-dialog': 'Standalone native <dialog> needing showModal wiring per demo-select; demo deferred — tracked in HS2-Z0CTHN.',
    };
