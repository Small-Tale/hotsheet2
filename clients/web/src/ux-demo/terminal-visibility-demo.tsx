...
export const terminalVisibilityDemoContextMenu=signal<{id:string;x:number;y:number}|undefined>(undefined),terminalVisibilityDemoNamePrompt=signal<TerminalVisibilityNamePrompt|undefined>(undefined);
export function TerminalVisibilityDialogDemo(){return <><TerminalVisibilityDialog open state={terminalVisibilityDemoState.value} scope="dashboard" groups={terminalVisibilityDemoGroups} contextMenu={terminalVisibilityDemoContextMenu.value}/><TerminalVisibilityNameDialog prompt={terminalVisibilityDemoNamePrompt.value}/></>}
