...
export function AppShellDemo() {
  ...
  const workspace = shellMode.value === 'terminals'
    ? <section class="shell-mode-surface" aria-label="Workspace grid workspace"><h2>Workspace grid</h2><p>Monitor and arrange terminals, AI chats, and future workspace tools across connected projects.</p></section>
