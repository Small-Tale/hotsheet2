...
export function TicketAttachmentsDemo() { return <section class="inspector-panel-demo" aria-label="TicketAttachments demo"><TicketAttachments attachments={[{ id: 'demo-video', name: 'choppy.mov' }]} /></section>; }
