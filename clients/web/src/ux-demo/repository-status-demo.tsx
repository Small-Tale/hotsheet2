...
const status:RepositoryStatus={
  ...
  commits:[
    {sha:'bbb2222',short_sha:'bbb2222',subject:'Refine repository status composition',committed_at:'2026-09-04T10:00:00Z'},
    {sha:'aaa1111',short_sha:'aaa1111',subject:'Build repository status browser',committed_at:'2026-09-04T09:00:00Z'},
  ],
};

export function RepositoryStatusPopoverDemo(){return <section aria-label="RepositoryStatusPopover demo"><RepositoryStatusPopover embedded status={status} view={repositoryDemoView.value}/><p class="component-stage__event" aria-live="polite">{repositoryDemoEvent.value}</p></section>}
