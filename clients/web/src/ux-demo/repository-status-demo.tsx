...
import { ChangeEvidenceDialog, type ChangeEvidenceView, type RepositoryFileMenu, RepositoryStatusPopover, type RepositoryStatusView } from '../components/repository-status-popover';
...
export function ChangeEvidenceDialogDemo(){return <section aria-label="ChangeEvidenceDialog demo"><ChangeEvidenceDialog embedded review={evidence} view={changeEvidenceDemoView.value} fileMenu={repositoryDemoFileMenu.value} platform="macos"/><p class="component-stage__event" aria-live="polite">{repositoryDemoEvent.value}</p></section>}
