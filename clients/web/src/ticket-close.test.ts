...
describe('structured ticket close outcomes', () => {
  ...
  it('keeps project, connection, and native identity exact across persistence', () => {
    ...
    expect(parseDuplicateReference('@beta/git-beta:ENG:42')).toEqual({
      project_id: 'beta',
      connection_id: 'git-beta',
      native_id: 'ENG:42',
    });
