...
const kerfSpacingMigratedComponents = [
  ...
  'command-navigation.css', 'command-settings-editor.css', 'connection-details-dialog.css', 'conversation-export-dialog.css', 'corrupt-ticket-row.css', 'flow-back-button.css',
