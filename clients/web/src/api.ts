...
export interface CheckoutTicketCounts {total:number;queued:number;backlog:number;archive:number;open:number;up_next:number;active:number;started:number;completed_today:number;completion_trend?:number[]}
