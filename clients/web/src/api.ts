...
export interface TicketRow {connection_id:string;native_id:string;qualified_id:string;id:string;slug:string;title:string;category?:string;priority?:string;status?:string;up_next:boolean;feedback_needed:boolean;tags:string[];blocked_by:string[];blocked_reason?:string;claimed_by?:string;claim_lease_expires_at?:string;worker_label?:string;claim_count:number;created_at?:string;updated_at?:string;completed_at?:string;details?:string;notes?:Note[]}
export interface CheckoutTicketQuery {text?:string;status?:string;open?:boolean;up_next?:boolean;blocked?:boolean;compact?:boolean}
