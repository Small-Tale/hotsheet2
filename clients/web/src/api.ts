...
export class Api {
  ...
  createCheckoutTicket=(checkout:string,value:{title:string;category:string})=>this.request<FullTicket>(`/checkouts/${encodeURIComponent(checkout)}/tickets`,{method:'POST',body:JSON.stringify(value)});
