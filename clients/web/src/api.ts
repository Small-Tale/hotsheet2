...
export interface CheckoutTicketQuery {text?:string;status?:string;collection?:'queue'|'archive';open?:boolean;up_next?:boolean;blocked?:boolean;close_reason?:TicketCloseReason;compact?:boolean;tags?:string;has_attachment?:boolean;has_media_annotation?:boolean;has_commit?:boolean;attachment?:string;created_after?:string;created_before?:string;updated_after?:string;updated_before?:string;completed_after?:string;completed_before?:string;verified_after?:string;verified_before?:string}
export interface CheckoutTicketCounts {total:number;queued:number;backlog:number;archive:number;open:number;up_next:number;active:number;started:number;verified?:number;completed_today:number;completion_trend?:number[]}
