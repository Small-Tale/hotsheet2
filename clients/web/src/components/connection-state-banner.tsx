...
const presentation = {
  ...
  offline: {
    label: 'Working from offline data',
    action: 'retry-connection',
  ...
  'compatibility-unknown': {
    label: 'Server compatibility unknown',
    action: 'show-connection-details',
    actionLabel: 'View details',
    icon: ShieldAlert,
    iconName: 'shield-alert',
  ...
  'revision-mismatch': {
    label: 'Different server build is running',
    action: 'show-connection-details',
    actionLabel: 'View details',
    icon: ShieldAlert,
    iconName: 'shield-alert',
  ...
  authentication: {
    ...
    action: 'authenticate-connection',
    actionLabel: 'Sign in',
    icon: KeyRound,
    iconName: 'key-round',
    tone: 'danger',
...
export function ConnectionStateBanner({ state, detail }: ConnectionStateBannerProps) {
  ...
  const action = item.action ? (
    <button
      type="button"
      data-action={item.action === 'show-connection-details' ? undefined : item.action}
      popoverTarget={item.action === 'show-connection-details' ? 'connection-details-dialog' : undefined}
    >
      {item.actionLabel}
    </button>
  ) : undefined;
