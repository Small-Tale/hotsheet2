...
export function ProjectSummary({ completedToday, inProgress, trend, projectId }: ProjectSummaryProps) {
  const maximum = Math.max(...trend, 1);
  return <button type="button" class="project-summary" data-component="project-summary" data-action="open-project-stats" data-project-id={projectId} aria-label={`Open project statistics: ${completedToday} completed today, ${inProgress} in progress`}>
