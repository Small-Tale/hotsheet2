...
export function ProjectSummary({ completed, inProgress, coverage, trend }: ProjectSummaryProps) {
  ...
  return <section class="project-summary" data-component="project-summary" aria-label="Project summary">
    <div class="project-summary__chart" role="img" aria-label="Recent ticket completion trend">
    ...
    <strong class="project-summary__coverage">{coverage}% coverage</strong>
  </section>;
}
