...
export function isCommandNavigationIcon(value: string): value is CommandNavigationIcon {
  return Object.hasOwn(icons, value);
}
/** The selectable command icons (key + Lucide node + name), for the command editor's icon picker. */
export const COMMAND_ICONS = (Object.entries(icons) as [CommandNavigationIcon, readonly [IconNode, string]][]).map(
