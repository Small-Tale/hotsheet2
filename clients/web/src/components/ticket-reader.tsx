...
export function TicketReader({ active = true, frameId = 'ticket-reader', open = true, projectName, stackPosition = 1, stackSize = 1, readOnly = false, style, overlay, ...props }: TicketReaderProps) {
