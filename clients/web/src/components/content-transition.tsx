...
export function ContentTransition({active,style='push',direction='forward',a,b,label='Changing content'}:{active:ContentTransitionSide;style?:ContentTransitionStyle;direction?:ContentTransitionDirection;a:SafeHtml;b:SafeHtml;label?:string}){
  return <section class="content-transition" data-component="content-transition" data-active-side={active} data-transition-style={style} data-transition-direction={direction} aria-label={label}>
