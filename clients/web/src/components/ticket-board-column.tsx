...
export function TicketBoardColumn({ id, title, tickets, selectionRoot = true }: TicketBoardColumnProps) {
  ...
  return <section class="ticket-board-column" data-component="ticket-board-column" data-column-id={id} data-ticket-drop-status={dropStatus} aria-label={`${title} column`}>
    <header>
