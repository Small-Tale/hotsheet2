...
export function AttachmentGallery({images,activeUrl,geometry={naturalWidth:0,naturalHeight:0,availableWidth:0,availableHeight:0},selectedScale,annotations=[],markup=false,selectedAnnotation,drawMode=false,playheadMs=0,durationMs=0,playing=false,volume=1,muted=false,annotationEnabled=true}:{images:readonly AttachmentGalleryImage[];activeUrl:string;geometry?:AttachmentGalleryGeometry;selectedScale?:number;annotations?:readonly MediaAnnotation[];markup?:boolean;selectedAnnotation?:string;drawMode?:boolean;playheadMs?:number;durationMs?:number;playing?:boolean;volume?:number;muted?:boolean;annotationEnabled?:boolean}) {
