...
export interface AttachmentGalleryImage {id:string;name:string;url:string;aliases?:readonly string[]}
...
export function AttachmentGallery({images,activeUrl}:{images:readonly AttachmentGalleryImage[];activeUrl:string}) {
  ...
  const index=Math.max(0,attachmentGalleryImageIndex(images,activeUrl)),image=images[index];
