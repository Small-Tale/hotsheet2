...
export function TicketInfoPanel({ status, priority, category, tags, details, detailsMode = 'preview', detailsDirty = false, readerPresentation = false, readerEditing = false, notes = [], editingNoteId, noteDraft, blockedReason = '', blockedReasonEditing = false, blockedReasonDraft = blockedReason, providerName = 'Hot Sheet git', updatedLabel = 'Updated now' }: TicketInfoPanelProps) {
