...
export function FeedbackPrompt({source,id,inlineReplies=[],selectedChoices=[],attachmentContext}:{source:string;id:string;inlineReplies?:readonly InlineFeedbackReply[];selectedChoices?:readonly string[];attachmentContext?:AttachmentReferenceContext}){
  const choiceGroup=parseFeedbackChoices(source),selected=new Set(selectedChoices);
