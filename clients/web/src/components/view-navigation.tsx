...
export interface ViewNavigationItem { id: string; label: string; count?: number; countLoading?: boolean; searchCount?: boolean; attention?: boolean; icon: 'needs-review' | 'all' | 'backlog' | 'archive' | 'errors' | 'custom'; manageable?: boolean }
