...
import { Archive, Clock3, FileWarning, type IconNode,Layers3, Plus, Search, ShieldAlert } from 'lucide';

import { LucideIcon } from './lucide-icon';
import { MenuHeader } from './menu-header';
import { MenuItem } from './menu-item';

export interface ViewNavigationItem { id: string; label: string; count?: number; attention?: boolean; icon: 'needs-review' | 'all' | 'backlog' | 'archive' | 'errors' | 'custom' }
