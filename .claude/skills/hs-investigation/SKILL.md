...
Call the `hotsheet_create` tool with `{ "title": "<TITLE>", "category": "investigation", "up_next": <true|false> }`. The HS2 shim is schema-validated and works serverless against the configured git store.
