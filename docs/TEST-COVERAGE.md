...
| ux-demo-workspace-header | docs/ux-components.md | Responsive project/view heading, accessible list/column/settings mode switching, shared equal-height borderless-child ToolbarControlGroup variants and demo, animated magnifier-to-visible-icon field search with autofocus and empty-blur collapse, live filtering, compact-caret checked sort menu, grouped favorite/more controls, and all-Lucide actions | `clients/web/src/components/workspace-header.test.ts`; `clients/web/src/ux-demo/workspace-components-demo.test.ts`; `clients/web/src/ux-demo/catalog.test.ts` | `clients/web/tests/ux-demo.spec.ts` | — | double-covered |
