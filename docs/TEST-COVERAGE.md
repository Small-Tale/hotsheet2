...
| ux-demo-ticket-collections | docs/ux-components.md | TicketList comfortable-width composition with outer-only edge rounding and unframed TicketBoard narrow status-column composition both render the identical responsive TicketRow contract, with counts, overflow, selection, Up Next actions, and no TicketCard implementation | `clients/web/src/components/ticket-list.test.ts`; `clients/web/src/components/ticket-board.test.ts`; `clients/web/src/ux-demo/catalog.test.ts` | `clients/web/tests/ux-demo.spec.ts` | — | double-covered |
| ux-demo-workspace-header | docs/ux-components.md | Responsive project/view heading, accessible list/column/settings mode switching, shared equal-height borderless-child ToolbarControlGroup variants and demo with whole-shell single hover versus 32px multi-item hover, animated magnifier-to-visible-icon field search with unclipped group focus/autofocus and empty-blur collapse, live filtering, compact-caret checked sort menu, grouped favorite/more controls, and all-Lucide actions | `clients/web/src/components/workspace-header.test.ts`; `clients/web/src/ux-demo/workspace-components-demo.test.ts`; `clients/web/src/ux-demo/catalog.test.ts` | `clients/web/tests/ux-demo.spec.ts` | — | double-covered |
| ux-demo-quick-ticket-composer | docs/ux-components.md | Collapsed/expanded composer, provider destination, required title, category selection, create insertion, cancel/reset, and unsupported-create presentation | `clients/web/src/components/quick-ticket-composer.test.ts`; `clients/web/src/ux-demo/workspace-components-demo.test.ts` | `clients/web/tests/ux-demo.spec.ts` | — | double-covered |
...
| ux-demo-ticket-inspector | docs/ux-components.md | Ticket identity, Up Next, close/reopen, metadata, shared StatusBadge/TagChip composition, and Info/Timeline/Attachments tabs | `clients/web/src/components/ticket-inspector.test.ts`; `clients/web/src/ux-demo/catalog.test.ts` | `clients/web/tests/ux-demo.spec.ts` | — | double-covered |
