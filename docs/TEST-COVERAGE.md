...
| ux-demo-tag-chip | docs/ux-components.md | Dev-only Hono UX catalog routing, hierarchical master/detail navigation, responsive persistent demo inspector with stable toggle and complete control reset, and reusable TagChip defaults/removal contract | `clients/web/src/components/tag-chip.test.ts`; `clients/web/src/ux-demo/catalog.test.ts` | `clients/web/tests/ux-demo.spec.ts` | — | double-covered |
...
| ux-demo-ticket-row | docs/ux-components.md | Initial list hierarchy, composed StatusBadge/TagChip, priority/category/status/tags/Up Next/selection/busy states, semantic row selection, and complete settings reset round trip | `clients/web/src/components/ticket-row.test.ts`; `clients/web/src/ux-demo/catalog.test.ts` | `clients/web/tests/ux-demo.spec.ts` | — | double-covered |
