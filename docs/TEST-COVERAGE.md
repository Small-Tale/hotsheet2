...
| ux-demo-ticket-collections | docs/ux-components.md | TicketList comfortable-width composition and TicketBoard narrow status-column composition both render the identical responsive TicketRow contract, with counts, overflow, selection, Up Next actions, and no TicketCard implementation | `clients/web/src/components/ticket-list.test.ts`; `clients/web/src/components/ticket-board.test.ts`; `clients/web/src/ux-demo/catalog.test.ts` | `clients/web/tests/ux-demo.spec.ts` | — | double-covered |
| ux-demo-workspace-header | docs/ux-components.md | Responsive project/view heading, accessible list/column switching over real collection components, expandable live filtering, and all-Lucide workspace actions | `clients/web/src/components/workspace-header.test.ts`; `clients/web/src/ux-demo/workspace-components-demo.test.ts`; `clients/web/src/ux-demo/catalog.test.ts` | `clients/web/tests/ux-demo.spec.ts` | — | double-covered |
