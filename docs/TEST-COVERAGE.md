...
| checkout-discovery | docs/04-core-server-cli.md | path-derived checkout ids, many-to-many registry, alias/path resolution | `crates/hotsheet-ticketing/src/checkouts.rs` | `crates/hotsheet-cli/tests/cli.rs`; `crates/hotsheet-server/tests/http.rs` | `docs/manual-test-plan.md` | double-covered |
