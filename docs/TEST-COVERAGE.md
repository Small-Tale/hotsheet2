...
| ux-demo-workspace-header | docs/ux-components.md | Responsive project/view heading, accessible list/column/settings mode switching, inline expanding live filtering, functional checked sort menu, pill-shaped mode/actions, grouped favorite/more controls, trailing search, and all-Lucide actions | `clients/web/src/components/workspace-header.test.ts`; `clients/web/src/ux-demo/workspace-components-demo.test.ts`; `clients/web/src/ux-demo/catalog.test.ts` | `clients/web/tests/ux-demo.spec.ts` | — | double-covered |
