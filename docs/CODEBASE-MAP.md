...
| Client design rules (Apple HIG: menus, shortcuts, dialogs, color/type, AI-content disclosure) | [design-guidelines.md](design-guidelines.md) — the distilled macOS HIG with per-client applicability, the shortcut register and menu-bar spec, and the §10 checklists; overrides listed in its §9; [ux-components.md](ux-components.md) for the component contract |
