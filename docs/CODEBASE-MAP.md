...
hot-sheet2/                  # this repo = CODE only; tickets are a SEPARATE store (below)
  ...
  crates/
    ...
    hotsheet-aitools/        # AI-tool host (behavioral half): the drive/transport interface
      ...
      src/drive.rs           #   Drive trait (+ service() -> BackingService accessor) + BackingService trait + Transport/Target/DriveCtx/TurnHandle/DoneReason; NativeActivity carries exact rich protocol payloads to the host mapper
