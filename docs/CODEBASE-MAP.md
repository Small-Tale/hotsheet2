...
hot-sheet2/                  # this repo = CODE only; tickets are a SEPARATE store (below)
  ...
  clients/web/               # Kerf + Web Awesome API-only web/Tauri UI foundation
    ...
    src/components/          #   Production domain UI components, including TerminalDashboard, RepositoryStatusPopover, shared Toolbar/ToolbarText/ToolbarControlGroup, Select, MenuItem/MenuHeader, project/page headers, sidebar/tab-shell surfaces; shared palette, cursor semantics, and Lucide policy
