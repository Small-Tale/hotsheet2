...
| Stable web development launcher | `clients/web/scripts/stable-dev.mjs` (temporary source snapshot; `npm run dev`) and `clients/web/playwright.config.ts` (`dev:hot` on an isolated test port), [06](06-clients.md) §6.3 |
