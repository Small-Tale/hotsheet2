...
| Terminal/PTY hosting for AI tools | 05 §5.4 | Partial (`hotsheet-terminals`: PTY + scrollback/live fan-out, manager, OSC 7/8/9/133 + spinner busy inference, server CRUD/input + live WS attach, tool-terminal busy→registry feed, explicit plugin `[launch]` setup/command composition, and detached broker preserving terminal streams/sizing across server restart — HS2-10/A6R5QV/XTTTMV/RCKEJ9/4M67VN/G0ETNQ/8HHFHN/ERT00F. Remaining: broker idle-GC/health → HS2-SV3XS8) |
